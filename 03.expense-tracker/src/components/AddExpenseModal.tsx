  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#14171A]/45 backdrop-blur-[2px] font-sans px-4">
      <div className="w-full max-w-120 max-h-[88vh] overflow-y-auto rounded-2xl bg-white border border-[#E3E0D8] shadow-[0_20px_60px_rgba(20,23,26,0.18)]">
        {/* Header */}
        <div className="flex items-start justify-between px-6 pt-5 pb-4 border-b border-[#E3E0D8]">
          <div>
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 rounded-xl border border-[#E3E0D8] bg-[#FBFAF7] px-4 py-3 focus-within:border-[#0053E2] focus-within:ring-2 focus-within:ring-[#0053E2]/15">
              ...
              />
              <span className="text-[12px] font-mono text-[#9C9885]">USD</span>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-[12px] font-medium text-[#4A4740]">
                Category
              </label>
              <span className="text-[11.5px] text-[#9C9885]">
            ...
            <p className="mt-2 text-[11.5px] font-medium text-[#B4560A] bg-[#FDF0E4] rounded-md px-2.5 py-1.5 inline-flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <div className="flex items-center gap-2 rounded-xl border border-[#E3E0D8] bg-[#FBFAF7] px-3.5 py-2.5 focus-within:border-[#0053E2] focus-within:ring-2 focus-within:ring-[#0053E2]/15">
                <Calendar size={15} className="text-[#9C9885]" />
                <input
          ...
          <div className="flex items-center justify-between rounded-xl border border-[#E3E0D8] bg-[#FBFAF7] px-3.5 py-2.5">
            <div className="flex items-center gap-2.5">
              <Wallet size={15} className="text-[#9C9885]" />
              <div>
          ...
          {/* Attachment */}
          <button className="flex items-center gap-2 text-[12.5px] font-medium text-[#0053E2]">
            <Paperclip size={14} />
            Attach receipt
          </button>
        </div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-between gap-3 px-6 py-4 border-t border-[#E3E0D8] bg-[#FAF9F5]">
          <button className="text-[13px] font-medium text-[#8A8778] hover:text-[#4A4740]">
            Delete draft
          </button>
          <div className="flex items-center gap-2.5">
            <button className="rounded-lg border border-[#E3E0D8] bg-white px-4 py-2 text-[13.5px] font-medium text-[#4A4740] hover:bg-[#F4F2EC] transition-colors">
              Cancel
            </button>
            <button className="inline-flex items-center gap-1.5 rounded-lg bg-[#0053E2] px-4 py-2 text-[13.5px] font-semibold text-white hover:bg-[#0047C4] transition-colors">
